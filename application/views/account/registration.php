...
<div id="register" class="tab-content z-depth-3 fade register-form">
	<form action="/account/registration" method="post" class="formBox">
		...
		<div class="inputBox">
			<label for="" class="labelText">Категория</label>
			<input type="text" name="category" class="userInput">
		</div>
		<div class="inputBox">
			<label for="" class="labelText">Описание</label>
