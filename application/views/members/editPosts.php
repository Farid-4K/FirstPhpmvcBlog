		...
		<div class="-new-post animation tab-content z-depth-3">
			<form enctype="multipart/form-data" action="/members/edit/" method="post">
				...
				<div class="buttons">
					...
					<button data-ripple-color="#fff" class="z-depth-1 material-ripple" name="editCreate" type="submit">Сохранить</button>
				</div>
			</form>
		</div>
	</div>
						...
						<div class="in-post-text tab-in">
							...
							<div>
								...
								<form verify="true" action="/members/edit/" method="post">
									...
									<button class="btn-post-delete hoverable h5 z-depth-1 button delete-post" type="submit" name="delete">Удалить</button>
								</form>
								<button class="btn-post-edit hoverable h5 z-depth-1 button delete-post" type="submit" name="edit">Редактировать</button>
							</div>
						</div>
					</div>
				<?php endforeach;?>
